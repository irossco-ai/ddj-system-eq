...
Headphone mode  ▸  LOW crossover −15 / −10 / −5 / Normal ✓ / +5 / +10 / +15 Hz
Bypass EQ          (toggle)
...
| `low_fc_offset_hz` | 0 | "Headphone mode": shifts the LOW band's corner from the mode's default (isolator 200 Hz / eq 120 Hz) in 5 Hz steps, −15…+15 |
